        ...
        <div className="admin-page analytics-page admin-tickets-page">
            ...
            {filterTarget && (
                <EditFiltersModal
                    ...
                    onSave={(filters) =>
                        handleSaveFilters(filterTarget, filters)
                    }
...
function CheckboxGroup({ options, selected, onChange, twoColumns }) {
    ...
    return (
        <div
            className={`manage-checkbox-group ${twoColumns ? "two-columns" : ""}`}
        >
            {options.map((v) => (
    ...
    return (
        <div className="manage-modal-overlay" onClick={onClose} role="dialog">
            ...
            >
                <div className="manage-modal-header">
                    <span>
                        Ticket Filters: {admin.full_name || admin.email}
                    </span>
                    <button
                        type="button"
                        className="manage-modal-close"
                ...
                >
                    This admin sees all tickets matching any checked value, plus
                    ones directly assigned to them.
                </p>
                <form className="manage-modal-form" onSubmit={onSubmit}>
