            ...
            <>
              <div className="manage-account-section">
                ...
                <form onSubmit={onSaveProfile}>
                  ...
                  {profileErr && (
                    <p className="manage-modal-err">{profileErr}</p>
                  )}
                  {profileMsg && (
                    <p className="manage-account-ok">{profileMsg}</p>
                  )}
              ...
              <div className="manage-account-section">
                <h3 className="manage-account-section-title">Password</h3>
                <form onSubmit={onChangePassword}>
                  ...
                  {pwErr && <p className="manage-modal-err">{pwErr}</p>}
                  {pwMsg && <p className="manage-account-ok">{pwMsg}</p>}
                  <div className="manage-modal-actions">
                    <button
                      type="submit"
                      disabled={savingPw}
